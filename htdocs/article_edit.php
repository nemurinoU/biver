...
<html>
	<head>
		<title>Edit <?php echo $article_results['article_title']; ?> - BiVER</title>
	...
	<body>
		...
		<div id="textareaa">
			<form type="post" action="edit_article.php">
				<input type="hidden" name="article_id" value="<?php echo $article_results['article_id']; ?>">
				<h3>Announcement Title</h3>
				<input type="text" name="article_title" value="<?php echo $article_results['article_title']; ?>" style="height: 4em; font-size: 32px;" required><br>

				<h3>Announcement Tagline</h3>
				<input type="text" name="article_tagline" value="<?php echo $article_results['article_tagline']; ?>" style="height: 2.5em; font-size: 16px;" required><br>
