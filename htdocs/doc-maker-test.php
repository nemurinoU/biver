...
<html>
	...
	<body>
		...
		<div id="textareaa">
			...
			<form name="tangina" method="get" action="save_article.php" onsubmit="return required()">
				<h3>Article Title</h3>
				<input type="text" name="article_title" value="" style="height: 4em; font-size: 32px;"><br>

				<h3>Article Tagline</h3>
				<input type="text" name="article_tagline" style="height: 2.5em; font-size: 16px;"><br>

				<h3>Body</h3>
				<textarea id="full-featured-non-premium" name="article_content">
				</textarea>
				<button class="btn btn-primary" >Publish</button>
			</form>
		</div>
		<div class="page-footer container-fluid px-0 pt-3 pb-0 text-center">
			...
			<h4 style="background-color: #010d2c" class="m-0 p-2"><span class="text-muted">@ 2019 Copyright:</span> BiVER</h4>
		</div>
