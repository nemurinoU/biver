...
<head>
	...
	<style>
			...
			/*-----------------------------------------<Specific Styling>----------------------------------------------*/
				.card-body > span > p > img, .card-body > p > .nailthumb-container {
					display: none;
				}
			    ...
			    while($row = mysqli_fetch_array($result)){
			    	if($row['article_status'] == "Active"){
			    		...
			    		echo "<div class='card-body'>";
			    			echo "<h4 class='card-title'> <a href='announcement.php?id=" . $row['article_id'] . "'>" . $row['article_title'] . "</a><small> by " . $row['article_contributor'] . "</small></h4>";
			    			echo "<h5 class='card-title'>" . $row['article_tagline'] . "</h5>";
			    			echo "<span class='card-text text-muted'>";
			    			echo substr($row['article_content'], 0, 300) . "<br>" . " <a class='badge badge-info' href='announcement.php?id=" . $row['article_id'] . "'>Read more</a>";
			    			echo "</span>";
